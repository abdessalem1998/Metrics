    ...
    <div className="container-fluid h-100 " style={{ backgroundColor: '#FC5193' }}>
      <div className="row ">
        ...
        <div className="row mb-5 text-center text-white ">
          <div className="col-6" style={{ backgroundImage: `url(${stat})`, backgroundSize: '100%', backgroundRepeat: 'no-repeat' }} />
          <div className="col-6">
            <h3>
              {singleData.name}
            </h3>
            <p>
              ...
              {singleData.today_confirmed}
            </p>
            <p>
              Total deaths:
              {singleData.today_deaths}
            </p>
            <p>
              {singleData.date}
              cases:
              {singleData.today_new_confirmed}
            </p>
            <p>
              {singleData.date}
              deaths:
              {singleData.today_new_deaths}
            </p>
          </div>
        </div>
